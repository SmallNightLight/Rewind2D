...
struct CollisionResponseInfo
{
    ...
    constexpr inline CollisionResponseInfo(Vector2 position1, Vector2 position2, Vector2 velocity1, Vector2 velocity2, Fixed16_16 angularVelocity1, Fixed16_16 angularVelocity2) :
        Position1(position1),
        Position2(position2),
        Velocity1(velocity1),
        Velocity2(velocity2),
